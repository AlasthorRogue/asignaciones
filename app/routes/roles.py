    ...
    if request.method == 'POST':
        ...
        if action == 'create':
            ...
            try:
                ...
                menu_keys = [
                    'dashboard', 'companies', 'users', 'roles', 'terminals', 'staff',
                    'warehouses', 'device_types', 'assignments', 'inventory', 'stock', 'reports',
                    'returns', 'create_return', 'delete_return', 'upload_return_document', 'view_return_document'
                ]
